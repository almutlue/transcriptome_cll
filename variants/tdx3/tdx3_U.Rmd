...
colData(ddsCLL)$PatID[which(colData(ddsCLL)$DDX3X == 1)]
...
ddsCLL <- ddsCLL[,which(colData(ddsCLL)[,"IGHV"] == "U")]
...
save(res_list, file="/home/almut/Dokumente/masterarbeit/data/desResIGHV_DDX3X_U_02122018.RData")
...
difftab <- function(condition){
  ...
  write.csv(dataTab, file=paste0("/home/almut/Dokumente/masterarbeit/results/noTsig/", condition, "_U_diffGenes.csv"))
  dataTab
}
