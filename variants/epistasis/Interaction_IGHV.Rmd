...
selPat <- filter(data.frame(varTab), IGHVmeth %in% "M") %>% select(-IGHVmeth) %>% filter(rowSums(is.na(.))!= (ncol(.) -1)) %>% select(PatID)
...
ggsave(file = "/home/almut/Documents/CLL/results/interaction/genesIGHV-M.svg", plot = g, width = 15, height = 200, limitsize = F)
...
#save(vecTab, file="/home/almut/Documents/CLL/data/interaction_IGHV-M_200917.RData")
...
ggsave(file = "/home/almut/Documents/CLL/results/interaction/piScoreIGHV-M.svg",plot = gg, width = 16, height = 108, limitsize = F)
