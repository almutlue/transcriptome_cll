...
```{r datasets}
#gene expression
#load("/home/almut/Documents/CLL/data/ddsrna_20170908.RData")  #trimmed dataset with Tsig included by Junyan, to integrate T-cell contamination as confounding factor 


load("/home/almut/Dokumente/masterarbeit/data/ddsrnaCLL_trimmed_tsig_modIGHV.RData")


#metaData
load("/home/almut/Dokumente/masterarbeit/data/patmetaGroups_170324.RData")
...
save(res_list, file="/home/almut/Dokumente/masterarbeit/data/desResIGHV_Tri_17072018.RData")

#tri12: 
#load("/home/almut/Dokumente/masterarbeit/data/desResTrisomy12_Tsig_IGHV_25102017.RData")
#load("/home/almut/Dokumente/masterarbeit/data/desResTri12_IGHV_17072018.RData")

#IGHV: 
#load("/home/almut/Dokumente/masterarbeit/data/desResIGHV_Tsig_Tri12_25102017.RData")
#load("/home/almut/Dokumente/masterarbeit/data/desResIGHV_Tri12_17072018.RData")

#Other: 
#load("/home/almut/Dokumente/masterarbeit/data/desRes_Tsig_IGHV_tri12_25102017.RData")
#load("/home/almut/Dokumente/masterarbeit/data/desResAll_IGHV_Tri12_17072018.RData")
...
#MA-plots
```{r ma-plots, eval=FALSE, include=FALSE}
#Check Ma plots
...
```{r hist, eval=FALSE, include=FALSE}
...
#Volcano plot
```{r volcano plots, eval=FALSE, fig.height=5, fig.width=5, include=FALSE}
...
```{r hierachical clustering, eval=FALSE, fig.height=50, fig.width=20, include=FALSE}
...
```{r tsne, eval=FALSE, fig.height=30, fig.width=30, include=FALSE}
...
setWiseGSA <- function(cond, gmtFile, numGenes){
 ...
 ggsave(file= paste0("~/git/figures_thesis/enrichment/gseaHallmark_", cond, ".svg"), plot=p, width=40, height=35)
  p
  }

cond <- gene_conditions
lapply(cond, FUN = "setWiseGSA", gmtFile = gsc, numGenes = 1)
