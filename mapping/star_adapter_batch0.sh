...
#BSUB -J CLLalign
#BSUB -n 10
#BSUB -o /g/huber/users/luetge/jobs/output/adapter/batch0/STAR_on_ARGUMENT_1_CLL_09.08.17_out.txt
#BSUB -e /g/huber/users/luetge/jobs/output/adapter/batch0/STAR_on_ARGUMENT_1_CLL_09.08.17_error.txt

#Aim: Write a Script to map fastqc files using STAR

#Setting Variables
date=adapter           #25062017
...
resultPath=${resPath}/${date}/batch0
...
/g/huber/users/luetge/software/sshpass-1.06/sshpass -v -p 'n3WS7a64duFHzAlv' /g/huber/users/dietrich/aspera/connect/bin/ascp  -Q -k1 -P 33001 -l300M emblwhub@dkfzaspera.dkfz-heidelberg.de:hipo_005/sequencing/rna_sequencing/view-by-pid/${sampleName} /scratch/aluetge/rawdata
  
    mv ${pathRawdata}/${sampleName}/tumor02 ${pathRawdata}/${sampleName}/tumor 
