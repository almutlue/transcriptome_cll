...
de2 <- readRDS(paste0(fig_dir,"/trisomy12/de_genes/PTPN6.rds"))
...
p_sub <- plot_grid(NULL, dosage, NULL, ncol = 3, rel_widths = c(1.2,8,1.2), labels = c('B','',''), label_size = 45)
#p_sub <- plot_grid(p_sub, NULL, rel_widths = c(10, 2))
p_sub2 <- plot_grid(NULL, de1, de2, de3, NULL, ncol = 1, labels = c('', 'C', 'D', 'E', ''), label_size = 45, rel_heights = c(0.5, 4, 4, 4, 0.5))
p_sub_3 <- plot_grid(tri12_net, NULL, p_sub, NULL, ncol = 1, rel_heights = c(7.5, 0.8, 4, 0.5), labels = c("A", ""), label_size = 45)
...
```{r fig4 plot, fig.width=20, fig.height= 24}
#Align subplots
...
p_sub5 <- plot_grid(p_sub3, NULL, path_epi, ncol = 1, rel_heights = c(12, 0.5, 4), labels = c("", "", "F"), label_size = 45)

figure4 <- plot_grid(p_sub5, NULL, p_sub, ncol = 3, rel_widths = c(12, 0.1, 11))
figure4
