...
#differentially expressed genes between gain8q24 groups (see differential expression.html)
...
mutStatus <- data.frame(colData(ddsCLL)) %>% arrange(gain8q24)
...
annocolor <- list(gain8q24 = c("1" = annocol[8], "0" = annocol[9]))
...
draw(h1 ) 
#dev.off()
saveRDS(h1, file = paste0(output_dir, "/figures/r_objects/gain8q24/gain8q24_heatmap.rds"))
```
...
gene_count <- function(gene_nam){
  ...
  saveRDS(p, file = paste0(output_dir, "/figures/r_objects/gain8q24/de_genes/", gene_nam, ".rds"))
  p
}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/gain8q24/gain8q24_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/gain8q24/gain8q24_enrichment_up.rds"))
```
