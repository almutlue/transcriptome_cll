...
saveRDS(h1, file = paste0(output_dir, "/figures/r_objects/med12/med12_heatmap.rds"))
```
...
gene_count <- function(gene_nam){
  ...
  saveRDS(p, file = paste0(output_dir, "/figures/r_objects/med12/de_genes/", gene_nam, ".rds"))
  p
}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/med12/med12_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/med12/med12_enrichment_up.rds"))
```
