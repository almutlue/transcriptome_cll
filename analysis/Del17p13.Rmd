...
#Filter chromosome 17 - we are not interested in the dosage effect 
diff_res <- diff_res[-which(diff_res$chromosome %in% c("17")),]
...
#ggsave(file=paste0(figure_dir,"/GSEA_", variant, "_Kegg.svg"), plot=p, width=14, height=7)
  ...
  saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del17p13/del17p13_enrichment.rds"))
