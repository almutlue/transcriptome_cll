...
mutStatus <- data.frame(colData(ddsCLL)) %>% arrange(del17p13)
...
annocolor <- list(del17p13 = c("1" = annocol[8], "0" = annocol[9]))
...
saveRDS(h1, file = paste0(output_dir, "/figures/r_objects/del17p13/del17p13_heatmap.rds"))
```
...
gene_count <- function(gene_nam){
  ...
  saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del17p13/de_genes/", gene_nam, ".rds"))
  p
}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del17p13/del17p13_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del17p13/del17p13_enrichment_up.rds"))
```
