...
diff <- diff_all[which( abs(diff_all$stat) > 4),]
...
```{r complex heatmap, fig.width= 15, fig.height=16}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del11q22/del11q22_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del11q22/del11q22_enrichment_up.rds"))
```
