...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/TP53/TP53_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/TP53/TP53_enrichment_up.rds"))
```
