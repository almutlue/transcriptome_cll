...
diff_all <- read.csv(file=paste0(output_dir, "/diff_genes/pretreatment/", variant, "_diffGenes.csv"))


rownames(diff_all) <- diff_all$X
diff_all <- diff_all[which(diff_all$padj < 0.05 ),-1]
diff <- diff_all
...
del17 <- read.csv(file=paste0(output_dir, "/diff_genes/pretreatment/del17p13_diffGenes.csv"))
