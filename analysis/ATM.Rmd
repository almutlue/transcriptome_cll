...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/atm/atm_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/atm/atm_enrichment_up.rds"))
```
