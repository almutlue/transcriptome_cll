...
Run piano
```{r piano, fig.width=10, fig.height=6}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/trisomy12/tri12_enrichment_dn.rds"))
...
p <- ggbarplot(enrichPlot, x = "pathway", y = "gene_number",
          fill = "p.adj",   
          orientation = "vertical",
          label = enrichPlot$pathway, lab.col = "white", lab.size = 4.5, lab.vjust = 0, lab.hjust = 1.01,
          sort.val = "none",         
          sort.by.groups = FALSE,     
          xlab = "Pathway",
          ylab = "gene number",
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/trisomy12/tri12_enrichment_up.rds"))
```
