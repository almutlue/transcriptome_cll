...
#Filter chromosome 13 - we are not interested in the dosage effect 
diff_res <- diff_res[-which(diff_res$chromosome %in% c("13")),]
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del13q14/del13q14_enrichment.rds"))
