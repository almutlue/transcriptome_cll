...
#differentially expressed genes between del13q14 groups (see differential expression.html)
...
mutStatus <- data.frame(colData(ddsCLL)) %>% arrange(del13q14)
...
annocolor <- list(del13q14 = c("1" = annocol[8], "0" = annocol[9]))
...
saveRDS(h1, file = paste0(output_dir, "/figures/r_objects/del13q14/del13q14_heatmap.rds"))
```
...
gene_count <- function(gene_nam){
  ...
  saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del13q14/de_genes/", gene_nam, ".rds"))
  p
}
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del13q14/del13q14_enrichment_dn.rds"))
...
saveRDS(p, file = paste0(output_dir, "/figures/r_objects/del13q14/del13q14_enrichment_up.rds"))
```
